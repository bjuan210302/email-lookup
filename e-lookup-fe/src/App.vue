<template>
  ...
  <div class="basis-3/5 max-h-screen overflow-y-auto">
    ...
    <div class="sticky top-0 px-5 py-5 bg-gray-100 border-solid border-b-2 border-gray-200">
      <div class="flex justify-between items-center">
        ...
        <div class="flex items-center min-w-[50%]">
          ...
          <button class="inline-flex ml-2" @click="() => showConfigModal = true">
    ...
    <div class="overflow-y-auto p-3">
      ...
      <div v-if="results.length === 0" class="absolute top-[50%] left-0 w-3/5
  ...
  <!-- CONFIG MODAL-->
  <ConfigModal v-if="showConfigModal" :close="() => showConfigModal = false" :searchConfig="searchConfig"
